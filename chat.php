...
<div class="col-11 col-lg-4 users-box row">
    ...
    <div class="col-12 chats">
        <div class="outgoing">
            This is jkjkad dsfn/sf sjflsdf sjfsfjlafs fsf sjdlf sdfsf djfmsg1
        </div>
        <br>
        <br>
        <div class="incoming">
            This is msg2hasjkdh d.jabdj kdad adajbdjada dajdband adjabdnad ajlda dndj
        </div>
        <br>
        <br>
        <div class="incoming">
            This is msg2hasjkdh d.jabdj kda adjabdnad ajlda dndj
        </div>
        <br>
        <div class="outgoing">
            ada akdja masdlk alkd
        </div>
        <br>
        <br>
        <div class="outgoing">
